...
{
	public sealed class ExaStreamWriter<TValue> : IDisposable
	{
		private InternalStreamWriter bw_;

		public ExaStreamWriter(int bufferSize = 655360)
		...
		public void Write(Stream stream, TValue value)
		{
			bw_.SetStream(stream);
			WriterAgentGenerator<InternalStreamWriter, TValue>.Run(bw_, value);
			bw_.Flush();
		}
	}
}
