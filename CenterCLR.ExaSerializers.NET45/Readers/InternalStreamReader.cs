...
{
	internal sealed class InternalStreamReader : InternalReaderBase
	{
...
#endif
#endif
		public InternalStreamReader(Encoding encoding, int bufferSize)
		...
		{
			return stream_.Read(buffer, offset, length); ;
		}
	}
}
